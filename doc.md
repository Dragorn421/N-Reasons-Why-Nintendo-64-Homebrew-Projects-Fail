Based on
[https://www.moria.us/blog/2021/07/9-reasons-why-nintendo-64-homebrew-projects-fail](https://www.moria.us/blog/2021/07/9-reasons-why-nintendo-64-homebrew-projects-fail)
...
- **Working without the stdlib.** You can use C or C++, but you shouldn’t use too much template instantiations (like `std::vector` with many different types).
